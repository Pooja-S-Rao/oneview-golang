...
func TestCheckVersion(t *testing.T) {
	...
	// 	# github.com/Pooja-S-Rao/oneview-golang/liboneview
	// import cycle not allowed in test
	// package github.com/Pooja-S-Rao/oneview-golang/liboneview (test)
	// 	imports github.com/docker/machine/drivers/oneview/ov
	// 	imports github.com/Pooja-S-Rao/oneview-golang/liboneview
	//
	// FAIL	github.com/Pooja-S-Rao/oneview-golang/liboneview [setup failed]
